...
def create_gmwm_img(img):
    ...
    new = np.where(img==MALPEM_GM, GM_LABEL, new)
    new = np.where(img==MALPEM_WM, WM_LABEL, new)
    return new
...
if __name__ == "__main__":
    transform_ss_to_gmwm("/home/lmahler/code/mpi_val/src/utils/malpem_tissues.txt", "/home/lmahler/data/scratch/malpem_val/")
